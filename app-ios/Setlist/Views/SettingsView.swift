    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                Text("Songs and albums from Spotify, Apple Music and YouTube Music play in the one you pick when it has them. SoundCloud and Bandcamp play in their own players.")
            }
